...
const features = [
  {
    ...
    description: "Easily log every job you apply to, update statuses, and keep a detailed timeline of your career journey.",
    icon: Briefcase,
  },
  {
    title: "Intelligent Job Search",
    description: "Search and filter jobs from integrated sources. Find roles tailored to your goals, experience, and location.",
    icon: Search,
  },
  {
    title: "Timeline Overview",
    description: "See your job hunt as a clear visual timeline. Spot patterns and never miss a follow-up again.",
    icon: CalendarClock,
  },
  {
    title: "Smart Reminders",
    description: "Get automatic nudges for interviews, deadlines, or rejections — never drop the ball.",
    icon: Bell,
  },
]
    ...
    <section className="py-24 bg-background">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Everything you need to stay organized, focused, and ahead of the job market — all in one beautiful dashboard.
        </motion.p>

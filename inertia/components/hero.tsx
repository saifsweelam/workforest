  ...
  return (
    <section className="relative overflow-hidden py-28 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Discover a smarter, decentralized way to find, post, and manage jobs. Powered by community. Built for the future.
        </motion.p>
        ...
        >
          ...
          <Button variant="ghost" size="lg" className="text-primary hover:underline">
